...
namespace Comments
{
    class Program
    {
       ...
       static void Main(string[] args)
       {
        ...
        Console.WriteLine("สวัสดี ชาวโลก!");
        /* Multiple line comments start with a slash and a star and can continue for several lines until a closing star and slash are encountered */
       }
    }
}